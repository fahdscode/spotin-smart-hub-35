-- Update existing clients to use the new barcode format
-- First, let's update all existing clients with the new barcode format
UPDATE public.clients 
SET barcode = generate_unique_barcode()
WHERE barcode LIKE 'C-%' OR barcode NOT LIKE 'BC-%';

-- Also ensure the client registration function uses the correct barcode format
