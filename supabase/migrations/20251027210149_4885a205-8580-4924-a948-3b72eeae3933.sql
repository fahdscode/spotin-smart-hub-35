-- Fix the test_client_registration function to use pgcrypto functions with proper schema
-- Extend search_path to include extensions schema where pgcrypto functions reside
...
BEGIN
    ...
    -- gen_salt and crypt are from pgcrypto extension
    hashed_password := crypt(p_password_hash, gen_salt('bf', 10));
