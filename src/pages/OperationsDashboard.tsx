            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {expenses.map(expense => <Card key={expense.id} className="p-4">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                              <div className={`p-2 rounded-lg ${expense.category === "Rent" ? "bg-primary/10 text-primary" : expense.category === "Salaries" ? "bg-success/10 text-success" : expense.category === "Electricity" ? "bg-warning/10 text-warning" : expense.category === "Marketing" ? "bg-accent/10 text-accent" : "bg-muted text-muted-foreground"}`}>
          ...
          <TabsContent value="control" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <Button variant="professional" className="w-full" onClick={() => {
