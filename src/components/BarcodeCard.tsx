...
const BarcodeCard = ({ 
  ...
  if (compact) {
    return (
      <div className="bg-gradient-to-br from-green-50 to-orange-50 rounded-lg p-4 border border-green-200">
        <div className="flex items-center gap-4">
          {/* Compact QR Code */}
          <div className="bg-white rounded-lg p-2 border border-green-100 shrink-0">
            <canvas 
              ref={canvasRef}
              className="block"
            />
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-green-700 truncate">{userName}</p>
            <div className="flex items-center gap-2 mt-1">
              <code className="text-xs font-mono text-green-600 bg-white/80 px-2 py-1 rounded">
                {barcode || clientCode}
              </code>
              <Button
                variant="ghost"
